...
<template>
    <!-- First table -->
    <!-- lets you change the props/options for the data table. vuetify iterates through the arrays you assign to the headers & items props
...
export default {
    ...
    methods: {
        ...
        getHeaders () {
            ...
            //iterates through object keys to build header array
